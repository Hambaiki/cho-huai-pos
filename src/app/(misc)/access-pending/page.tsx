...
import { getCurrentUser, getUserAccessStatus } from "@/features/auth/queries";
    ...
    <main className="mx-auto flex min-h-screen w-full max-w-xl flex-col justify-center px-6 py-12">
      <div className="rounded-2xl border border-amber-200 bg-amber-50 p-6">
        ...
        <p className="mt-2 text-sm text-amber-800">
          Your account was created successfully, but it is currently suspended
          by default. Please contact a super admin to approve your access.
        </p>
        ...
        <form action={signOutAction} className="mt-6">
          <Button className="bg-amber-700 hover:bg-amber-800" type="submit">
            Sign out
          </Button>
        </form>
      </div>
