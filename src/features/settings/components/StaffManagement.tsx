...
import { StaffRemovalModal } from "../components/StaffRemovalModal";
...
export function StaffManagement({
  ...
  const [selectedForRoleEdit, setSelectedForRoleEdit] =
    useState<StaffMember | null>(null);
  const [pendingRole, setPendingRole] = useState<StoreMemberRole>("cashier");
  ...
  function openRoleModal(member: StaffMember) {
    ...
    setPendingRole(member.role as StoreMemberRole);
  }
  ...
  function handleRoleChange(memberId: string, nextRole: StoreMemberRole) {
    if (!effectiveStoreId) return;
    setMemberActionError(null);
