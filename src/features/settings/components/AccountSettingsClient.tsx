...
import { PasswordStrengthMeter } from "@/components/ui/form";
import {
  deleteAccountAction,
  signOutAction,
...
import { PWA_INSTALL_DISMISS_KEY } from "@/features/shell/pwa/constants";
      ...
      <SectionCard>
        ...
        <form action={profileAction}>
          <SectionCardBody className="space-y-5">
            ...
            <FormError
              message={!profileState?.ok ? profileState?.error : null}
            />
            <FormSuccess
              message={profileState?.ok ? profileState?.message : null}
            />
          </SectionCardBody>
      ...
      <SectionCard>
        ...
        <form action={emailAction}>
          <SectionCardBody className="space-y-5">
            ...
            <FormError message={!emailState?.ok ? emailState?.error : null} />
            <FormSuccess
              message={emailState?.ok ? emailState?.message : null}
            />
          </SectionCardBody>
        ...
        <form action={passwordAction} className="space-y-5">
          <SectionCardBody className="space-y-5">
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <FormError
                message={!passwordState?.ok ? passwordState?.error : null}
              />
              <FormSuccess
                message={passwordState?.ok ? passwordState?.message : null}
              />
            </div>
          </SectionCardBody>
          <SectionCardFooter>
      ...
      <SectionCard>
        ...
        <form action={deleteAction}>
          <SectionCardBody className="space-y-4">
            ...
            <FormError message={!deleteState?.ok ? deleteState?.error : null} />
          </SectionCardBody>
          <SectionCardFooter>
            <Button
              type="submit"
